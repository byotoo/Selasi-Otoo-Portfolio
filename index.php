						...
						<div class="menu-nav">
							<ul class="menu-list">
								...
								<li class="has-children">
									<a href="about-me.html" class="#">About</a>
								</li>
								<li class="has-children">
				...
				<section id="intro" class="slideshow bg-dark">
					...
					* Available carousel data attributes:
					...
					<div class="owl-carousel cursor-grab fade-out-scroll-5 nav-bottom-right" data-items="1" data-dots="false" data-nav="true">
						...
						<!-- Begin carousel item 
						========================= -->
						<div class="cc-item parallax bg-image" style="background-image: url(assets/img/intro/intro-bg-1.jpg); background-position: 50% 50%;" data-percent-height="0.9">

							<!-- Begin caption -->
							<div class="cc-caption intro-caption bottom-left caption-animate">
								<h1 class="intro-title">Welcome!<br>I Am Selasi Otoo</h1>
								<div class="intro-sub-title-wrap max-width-400"> <!-- max width class is optional -->
									<h2 class="intro-sub-title">
										The creative director you've been looking for.
									</h2>
								</div>
							</div>
							<!-- End caption -->
						...
						<div class="cc-item parallax bg-image" style="background-image: url(assets/img/intro/intro-bg-2.jpg); background-position: 50% 50%;" data-percent-height="0.9">
							...
							<!-- Begin caption -->
							<div class="cc-caption intro-caption bottom-left caption-animate">
								<h1 class="intro-title">All<br>Your Creatve Needs</h1>
								<div class="intro-sub-title-wrap">
									<h2 class="intro-sub-title">
										From Videography to photography to Graphic designs!
									</h2>
								</div>
							</div>
							<!-- End caption -->
						...
						<div class="cc-item parallax bg-image" style="background-image: url(assets/img/intro/intro-bg-3.jpg); background-position: 50% 55%;" data-percent-height="0.9">
							...
							<!-- Begin caption -->
							<div class="cc-caption intro-caption bottom-left caption-animate">
								<h1 class="intro-title">I Dey For You <br>Anyday, Anytime</h1>
								<div class="intro-sub-title-wrap">
									<h2 class="intro-sub-title">
										Just Hit me Up!
									</h2>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="row-md-height">
								...
								<!-- Column -->
								<div class="col-md-2 col-md-height col-md-middle no-padding">

									<!-- Begin split box content -->
									<div class="split-box-content">

										<h3>- Explore my world of visuals, where imagination meets precision.</h3>										
								...
								<!-- Column -->
								<div class="col-md-6 col-md-height col-md-middle no-padding" style="background-image: url(assets/img/patterns/swirl-3.png);">

									<!-- Begin split box content -->
									<div class="split-box-content text-gray-3 link-main">
										<p>Each project here represents a journey of vision, collaboration, and craft from concept development to final execution. 
											<br>
											<br>
											🎬 Cinematography: Visual storytelling through motion films, ads, documentaries, and brand stories.
											<br>
											📷 Photography: Capturing life's raw moments, emotions, and personalities through my lens.
											<br>
											🖌️ Graphic Design: Crafting visuals that speak with clarity, creativity, and purpose.
											<br>
											💡 Creative Direction: Leading projects that merge strategy with artistry to create impact.</p>
									</div>
									<!-- End split box content -->
							...
							<div class="isotope-items-wrap pli-caption-alter">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-2">
									...
									<a target="_blank" href="https://www.youtube.com/shorts/WoCw0HvhuVI?feature=share" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/suicide-prevention.png); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Suicide Prevention Campaign</h2></div>
												<div><span class="pli-category">Motion</span></div>
											</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1">
									...
									<!-- Begin portfolio list item -->
									<a target="_blank" href="https://youtu.be/MMXOYnXZ9lM" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/Let-gigi-cook.png); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Let Gigi Cook</h2></div>
												<div><span class="pli-category">Motion</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1">
									...
									<!-- Begin portfolio list item -->
									<a target="_blank" href="https://youtu.be/P2BsOt0Gvwo" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/accra-london.png); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Accra to London</h2></div>
												<div><span class="pli-category">Motion</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1">
									...
									<!-- Begin portfolio list item -->
									<a target="_blank" href="https://youtube.com/shorts/_EBm6K1PzOk" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/start-of-societ-logo.png); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Start of Society</h2></div>
												<div><span class="pli-category">Motion</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-2">
									...
									<!-- Begin portfolio list item -->
									<a target="_blank" href="https://youtube.com/shorts/miP7f5JytJM" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/intercultural-motion-graphics.png); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Intercultural</h2></div>
												<div><span class="pli-category">Motion</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-2">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-6.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-8.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Photoshoot</h2></div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-6.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-7.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Birthday</h2></div>
												<div><span class="pli-category">Print</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-6.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-9.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Denim Sunday</h2></div>
												<div><span class="pli-category">Print</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1">
									...
									<!-- Begin portfolio list item -->
									<a target="_blank" href="https://wolfmoment.mypixieset.com/?fbclid=PAdGRleANcVmlleHRuA2FlbQIxMQABp7TtS7NN6ZJewyve3-SXtgJYT_P7njhMZYQD8yqBYgOvUFEGJJ9Y-QrNI6rM_aem_R5WoqtU2f71-UjYEWz3vLg" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-10.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Full Production</h2></div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="footer-text">
								<h4>- Creative Vision. Bold Stories. Timeless Design.</h4>
								I'm a Creative Director passionate about transforming ideas into visuals that move people.From cinematic storytelling and photography to brand identity and digital design — I craft experiences that connect, inspire, and leave a lasting impact.
							</div>
							<!-- End footer text -->
						...
						<div class="col-md-4">
							...
							<div class="copyright">
								...
								Designed by <a target="_blank" href="#">ChrisTechMedia</a>
							</div>
							<!-- End copyright -->
